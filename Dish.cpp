...
bool Dish::operator==(const Dish &rhs) const
{
    ...
    return name_ == rhs.name_ &&
           ...
           cuisine_type_ == rhs.cuisine_type_ &&

           prep_time_ == rhs.prep_time_ &&
...
bool Dish::operator!=(const Dish& rhs) const{
    ...
    return !(name_ == rhs.name_ && prep_time_ == rhs.prep_time_ && price_ == rhs.price_ && cuisine_type_ == rhs.cuisine_type_);
}
